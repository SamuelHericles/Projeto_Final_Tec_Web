...
?>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <h2 class="my-4">Nossos serviços</h2>
        <div class="list-group">
          <a href="#1" class="list-group-item active">Manutenção de eletrônicos</a>
          <p></p>
          <a href="#2" class="list-group-item active">Formatação e restauração</a>
          <p></p>
          <a href="#3" class="list-group-item active">Upgrades de computadores</a>
        </div>
      </div>
